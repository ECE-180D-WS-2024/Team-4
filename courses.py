...
#[winwidth -198, 592, 200, 8, 'green'] green for level 1 
...
#lvl1 = tutorial
#lvl2 = platform water (STICKY BALL/STROKE REDUCTION/Heavy Handed)
#lvl3 = hay to left and right (Gravity Vortex, makes things fall faster)
#lvl4 = platformer with lots of water (STICKY BALL/STROKE REDUCTION/Heavy Handed)
#lvl5 = good, complex not too hard
#lvl6 = dont include, sticky wall and lasers?
#lvl7 = sticky wall but include
#lvl8 = 
course1 = [lvl1, lvl2, lvl3, lvl7, lvl8, lvl6, lvl7, lvl8, lvl9]

#Actual levels to play currently, try to get through later tonight, add powerups
course2 = [lvl1, lvl3, lvl2, lvl5, lvl4, lvl7]
#course1 = [lvl1]1
